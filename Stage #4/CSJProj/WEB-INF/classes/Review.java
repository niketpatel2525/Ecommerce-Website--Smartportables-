...
public class Review {
	...
	public Review(int productId, String productName, double productPrice, String manufacturer, boolean productOnSale,
	...
	public String toString() {
		return "Review [productId=" + productId + ", productName=" + productName + ", productPrice=" + productPrice
				+ ", manufacturer=" + manufacturer + ", productOnSale=" + productOnSale + ", retailername="
