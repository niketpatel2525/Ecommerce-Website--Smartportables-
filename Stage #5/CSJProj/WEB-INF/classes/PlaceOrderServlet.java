...
public class PlaceOrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (orderSize > 0 && place == null) {
			...
			if (resultcode > 0) {
				...
				out.print("<div id='body'>" + "<section id='content'>"
						+ "<center>"
						+ "<h3>Order with orderID: &nbsp"
						+ resultcode
						+ " Placed   ....</h3>"
						+ "<h5>Delivery Date: "
				...
				out.print("<div id='body'>" + "<section id='content'>"
						+ "<center>"
						+ "<h3>Error occured. Please try again later.</h3>"
						+ "</center>"
						+ "</section>"
						+ "</div>");
			}
	...
	private String getLoginHTML() {
		return "<div id='body'>" + "<section id='content'>"
				...
				+ "<div class='col-md-6'>"
				+ "<div class='container'>"
				+ "<form class='form-signin' method='post' action='/CSJProj/PlaceOrderServlet?place=success'>"
