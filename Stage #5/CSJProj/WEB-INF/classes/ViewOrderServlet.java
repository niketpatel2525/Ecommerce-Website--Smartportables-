...
public class ViewOrderServlet extends HttpServlet {
	...
	private String getOrderView(Order ord) {
		...
		String _Header = "<div class='row'>" + "<form action='/CSJProj/CancelOrderServlet' method='post'>"
				+ "<div class='box'>"
				+ "<div class='box-header'>"
				+ "<h3 class='box-title'>Order Details</h3>"
				+ "<input type='hidden' name='cancelOrder' value ='"
				+ ord.getOrderId()
				+ "'>"
	...
	private String getHTMLContent() {
		return "<div id='body'>" + "<section id='content'>"
				...
				+ "<div class='col-md-6'>"
				+ "<div class='container'>"
				+ "<form class='form-signin' method='post' action='/CSJProj/ViewOrderServlet?order=display'>"
