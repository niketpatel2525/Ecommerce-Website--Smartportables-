...
public class Trending extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		LinkedHashMap<String, Integer> zipCode = mdsu.getTopZip();
		...
		out.println(getHTMLContent(mostLiked, zipCode, mostReviewed));
	...
	private String getHTMLContent(LinkedHashMap<String, Float> mostLiked, LinkedHashMap<String, Integer> zipCode,
			LinkedHashMap<String, Integer> mostReviewed) {
		String _Heading = "" + "<div id='body'>"
				+ "<section id='content'>"
				+ "";
		String _content = "";

		_content = "" + "<center><h2>Top Zip Code</h2></center>"
				+ "<table>"
				+ "<tr>"
				+ "<th>"
				+ "Zip Code"
		...
		_content += "</table>";
		_content += "" + "<center><h2>Most Liked</h2></center>"
				+ "<table>"
				+ "<tr>"
				+ "<th>"
				+ "Product Name"
		...
		_content += "<center><h2>Most Reviewed</h2></center>" + "<table>"
				+ "<tr>"
				+ "<th>"
				+ "Product Name"
				+ "</th>"
