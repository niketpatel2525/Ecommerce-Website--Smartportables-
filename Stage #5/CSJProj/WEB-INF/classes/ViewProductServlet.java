...
public class ViewProductServlet extends HttpServlet {
	...
	private String getReviews(HashMap<String, ArrayList<Review>> reviews, String productId) {
		String _Header = "" + "<div class='container'>"
				+ "<center>"
	...
	private String getReviewForm(String productId) {
		String _Content = "<form class='review-form' method='get' action='/CSJProj/ViewProductServlet'>"
				...
				+ "<center>"
				+ "<h2 class='form-signin-heading'>Write Review about Products</h2>"
				+ "</center>"
				+ "<div class='form-group'>"
				+ "<div class='row'>"
				+ "<div class='col-md-12'>"
				+ "<label class='dark'>Retailer Name:</label>"
				+ "<input type='text'  value='Smartportables' name='retailername'>"
				+ "</div>"
				+ "</div>"
				+ "<div class='row'>"
				+ "<div class='col-md-4'>"
				+ "<label class='dark'>Zip:</label>"
				+ "<input type='text'	name='retailerzip' value='60120'>"
				+ "</div>"
				+ "<div class='col-md-4'>"
				+ "<label class='dark'>City:</label>"
				+ "<input type='text' name='retailercity' value='Chicago'>"
				+ "</div>"
				+ "<div class='col-md-4'>"
				+ "<label class='dark'>State:</label>"
				+ "<input type='text' name='retailerstate' value='IL'>"
				+ "</div>"
				+ "</div>"
				+ "</div>"
				+ "<div class='form-group'>"
	...
	private String getCarousel(String productId) {
		...
		String _Heading = "" + "<div class='container'>"
				+ "<div class='col-md-12'>"
		...
		for (Map.Entry<Integer, ArrayList<Accessory>> entry : accessories.entrySet()) {
			...
			for (int i = 0; i < count; i += 3) {
				...
				for (int j = i; j < (i + 3); j++) {
					if (j < count) {
						_Content += "" + "<div class='col-xs-4'>"
								+ "<table>"
								+ "<tr>"
								+ "<td>"
								+ "<img class='img-thumbnail accessory-img-block' src='"
								+ accessory.get(j).getImage()
								+ "' alt='IMG'>"
								+ "</td>"
								+ "</tr>"
								+ "<tr>"
								...
								+ accessory.get(j).getManufacturer()
								+ "</label>"
								+ "</td>"
								+ "</tr>"
								+ "<tr>"
