...
public class Utilities extends HttpServlet {
	...
	public String printHtmlUserLeftNav(String file, User currentUser) {
		...
		if (currentUser.getRole() == 0) {
			replaceBy = "" + "<li>"
					+ "<h4>User Control</h4>"
					+ "<ul>"
					+ "<li><a href='/CSJProj/ViewOrderServlet\'>View Order</a></li>"
					+ "<li><a href='/CSJProj/LogoutServlet'>Logout</a></li>"
					+ "</ul>"
					+ "</li>";
			...
			replaceBy = "" + "<li>"
					+ "<h4>User Control</h4>"
					+ "<ul>"
					+ "<li><a href='/CSJProj/AddProduct'>Add Product</a></li>"
					+ "<li><a href='/CSJProj/UpdateProduct'>Update Product</a></li>"
					+ "<li><a href='/CSJProj/InventoryServlet'>Inventory Report</a></li>"
					+ "<li><a href='/CSJProj/SalesServlet'>Sales Report</a></li>"
					+ "<li><a href='/CSJProj/LogoutServlet'>Logout</a></li>"
					+ "</ul>"
					+ "</li>";
			...
			replaceBy = "" + "<li>"
					+ "<h4>User Control</h4>"
					+ "<ul>"
					+ "<li><a href='/CSJProj/Registration\'>Register Customer</a></li>"
					+ "<li><a href='/CSJProj/UpdateOrder\'>View Order</a></li>"
					+ "<li><a href='/CSJProj/LogoutServlet'>Logout</a></li>"
					+ "</ul>"
					+ "</li>";
	...
	public String printHtmlUserHeader(String file, User currentUser) {
		...
		String replaceBy = "Cart<sup>(" + StartupServlet.cart.size()
				+ ")</sup>";
		result = HTMLStringReplace(result, lookupString, replaceBy);

		lookupString = "Hi There! Welcome.";
		replaceBy = "Hi " + currentUser.getFname()
				+ "! Welcome.";
		result = HTMLStringReplace(result, lookupString, replaceBy);
