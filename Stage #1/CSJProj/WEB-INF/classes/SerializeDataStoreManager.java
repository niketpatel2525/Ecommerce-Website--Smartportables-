...
public class SerializeDataStoreManager {
	...
	private static final String USER$INFO = "C:/Tomcat/webapps/CSJProj"+"/webdata/person.txt";
	private static final String ORDER$INFO = "C:/Tomcat/webapps/CSJProj"+"/webdata/order.txt";
