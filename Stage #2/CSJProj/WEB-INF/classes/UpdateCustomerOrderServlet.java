...
private String getOrderView(Order ord) {
		...
		String _Header = "<div class='row'>"
				...
				+ "<a class='btn btn-danger pull-right' role='button'  href='/CSJProj/CancelOrderServlet?cancelOrder="+ord.getOrderId()+"'    >Cancel Order</a>"
				+ "</div>"
				+"<div class='row'>"
				+ "<div class='col-sm-3'>"
		...
		for (Map.Entry<Product, Integer> entry : cart.entrySet()) {
			...
			total +=subtotal;
				...
				_Content +=""
						+ "<form action='/CSJProj/UpdateCustomerOrderServlet?update=true' method='post'>"
						+ "<tr>"
